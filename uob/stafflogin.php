...
<div class="container">
					<a href="stafflogin.php" class="btn btn-danger">Staff Login</a>
...
<div class="container" style="width: 400px; margin-top:50px";>
	...
	<form class="form-group" action="stafflogin_process.php" method="post">
		<label>Email</label>
		<input type="text" name="username" class="form-control" placeholder="Enter your Email" required=""><br>
